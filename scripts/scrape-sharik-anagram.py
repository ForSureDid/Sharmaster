#!/usr/bin/env python3
"""
Scrapes Anagram foil balloon products from new.sharik.ru.
URL: https://new.sharik.ru/tovary-dly-prazdnika-cat/folgirovannye-shary/?properties=27917

Saves as: Anagram_<full name>_<code>.<ext>
Run: python3 scripts/scrape-sharik-anagram.py
"""
...
CATEGORY_URL = (
    ...
    "?properties=27917&page={page}"
)
OUT_DIR = os.path.join(os.path.dirname(__file__), "..", "scraped-sharik-anagram")
...
def main():
    ...
    for i, item in enumerate(all_items, 1):
        ...
        filename = f"Anagram_{clean_filename(name)}_{clean_filename(code) if code else 'no-code'}{ext}"
