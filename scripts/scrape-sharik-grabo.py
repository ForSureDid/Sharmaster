#!/usr/bin/env python3
"""
Scrapes Grabo foil balloon products from new.sharik.ru.
URL: https://new.sharik.ru/tovary-dly-prazdnika-cat/folgirovannye-shary/?properties=27934

Saves as: Grabo_<full name>_<code>.<ext>
Run: python3 scripts/scrape-sharik-grabo.py
"""
...
CATEGORY_URL = (
    ...
    "?properties=27934&page={page}"
)
OUT_DIR = os.path.join(os.path.dirname(__file__), "..", "scraped-sharik-grabo")
...
def main():
    ...
    for i, item in enumerate(all_items, 1):
        ...
        filename = f"Grabo_{clean_filename(name)}_{clean_filename(code) if code else 'no-code'}{ext}"
