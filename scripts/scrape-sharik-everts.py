#!/usr/bin/env python3
"""
Scrapes Everts latex balloon products from new.sharik.ru category page.
URL: https://new.sharik.ru/tovary-dly-prazdnika-cat/lateksnye-shary/shary-bez-risunka-po-tsvetam/?properties=27936

Saves as: Everts_<full name>_<code>.<ext>
Run: python3 scripts/scrape-sharik-everts.py
"""
...
CATEGORY_URL = (
    BASE_URL
    + "/tovary-dly-prazdnika-cat/lateksnye-shary/shary-bez-risunka-po-tsvetam/"
    "?properties=27936&page={page}"
)
OUT_DIR = os.path.join(os.path.dirname(__file__), "..", "scraped-sharik-everts")
...
def main():
    ...
    for i, item in enumerate(all_items, 1):
        ...
        filename = f"Everts_{name_clean}_{code_clean}{ext}"
