...
export default function RegisterPage() {
  ...
  function handlePhoneChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    // Strip all non-digits, then reformat
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (rawDigits.length < 11) { setError("Введите полный номер телефона"); return; }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-pink-50 to-green-50 flex flex-col items-center justify-center px-4 py-12">
      ...
      <a href="/" className="mb-8">
        <Image src="/logo-nobg.png" alt="Sharmaster" width={280} height={80} className="h-20 w-auto" />
      </a>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onFocus={(e) => { if (!form.phone || form.phone === "") set("phone", "+7-("); e.target.setSelectionRange(e.target.value.length, e.target.value.length); }}
