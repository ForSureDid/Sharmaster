        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center gap-3 h-14">
          ...
          <div className="flex items-center ml-auto">
            ...
            <a href="/sale" className="hidden sm:flex flex-col items-center gap-0.5 px-3 py-1.5 text-gray-600 hover:text-gray-900 transition-colors flex-shrink-0">
              ...
              <span className="text-[10px] text-gray-400 leading-none">Акции</span>
            </a>
            ...
            <div className="relative" ref={accountRef}>
              {user ? (
                <button
                  ...
                  className="flex flex-col items-center gap-0.5 px-3 py-1.5 text-gray-600 hover:text-gray-900 transition-colors"
                >
                  <div className="w-6 h-6 rounded-full bg-sky-400 flex items-center justify-center text-white text-xs font-bold">
                    {user.name.charAt(0).toUpperCase()}
                  </div>
                  <span className="text-[10px] text-gray-400 leading-none hidden sm:block">{user.name.split(" ")[0]}</span>
                </button>
              ) : (
                <a href="/login" className="flex flex-col items-center gap-0.5 px-3 py-1.5 text-gray-600 hover:text-gray-900 transition-colors">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                  <span className="text-[10px] text-gray-400 leading-none hidden sm:block">Войти</span>
                </a>
              )}
              {accountOpen && user && (
            ...
            {/* Избранное */}
            <a href="/liked" className="flex flex-col items-center gap-0.5 px-3 py-1.5 text-gray-600 hover:text-gray-900 transition-colors relative">
              ...
              <span className="text-[10px] text-gray-400 leading-none hidden sm:block">Избранное</span>
            </a>
            ...
            <button onClick={openCart} className="flex flex-col items-center gap-0.5 px-3 py-1.5 text-gray-600 hover:text-gray-900 transition-colors">
              <div className="relative">
                ...
                {totalCount > 0 && (
                  <span className="absolute -top-1.5 -right-1.5 min-w-[16px] h-4 px-0.5 bg-sky-400 text-white text-[10px] font-bold rounded-full flex items-center justify-center">
